...
class PracticalTest01Var07SecondaryActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val input3 = intent.getIntExtra("INPUT3", 0)
        val input4 = intent.getIntExtra("INPUT4", 0)
        ...
        sumButton.setOnClickListener {
            ...
            setResult(RESULT_OK, Intent().putExtra("SUM_RESULT", sum))
        ...
        productButton.setOnClickListener {
            ...
            setResult(RESULT_OK, Intent().putExtra("PRODUCT_RESULT", product))
